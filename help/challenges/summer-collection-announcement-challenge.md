...
2. *Luma - 여름 컬렉션 발표*&#x200B;라는 여정 만들기는 다음 지침을 기반으로 합니다.
   ...
   2. 이틀 동안 기다렸다가 더 많은 타겟팅된 컨텐츠가 있는 후속 이메일 메시지를 보냅니다.
   ...
   3. 상단의 타겟팅된 이메일을 보낸 후 이메일이 열릴 때까지 2일 기다립니다.
   4. 타겟팅된 이메일이 2일 이내에 열리지 않으면 최종 재타겟팅 시도로서 **Luma - 20 % 할인 컬렉션 이메일**&#x200B;을 보냅니다.
