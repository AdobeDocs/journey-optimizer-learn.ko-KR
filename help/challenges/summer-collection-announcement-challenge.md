...
Luma 마케팅 팀은 Journey Optimizer에서 여름 컬렉션 마케팅 캠페인을 구현하도록 요청합니다. Journey Optimizer에서 여정을 만드는 것이 당면 과제입니다. 특히 필요한 세그먼트를 만들고, 4개의 메시지를 만들고, 여정을 빌드해야 합니다.
...
세그먼트 빌더에서 예상 자격 있는 프로필 수를 볼 수 있습니다.
