---
user-guide-title: Adobe Journey Optimizer의 웹 경험을 위한 AI 기반 의사 결정
user-guide-description: 이 랩에서는 Adobe Journey Optimizer을 사용하여 의사 결정 시스템을 구성하는 방법을 알아봅니다. 재무 프로필 및 실시간 작업을 고려하여 고객당 가장 적합한 제품 오퍼를 식별하는 로직을 구성한 다음 웹 배너 및 SMS를 통해 일관되게 배포합니다.
role: User
level: Beginner,Intermediate
breadcrumb-title: 웹 경험을 위한 ai 기반 의사 결정
...
# 웹 경험을 위한 AI 기반 의사 결정 {#ai-powered-decisioning-for-web-experiences}

+ [소개](/help/summit-lab-2026/introduction.md)
+ [랩 환경 설정](/help/summit-lab-2026/set-up-the-lab-environment.md)
