---
title: 고객 여정 경험
description: Adobe Journey Optimizer에서 오케스트레이션한 SecurFinancial 데모 사이트(실시간 SMS를 트리거하는 대출 애플리케이션을 통해, 익명 방문자에서 개인화된 제품 오퍼가 있는 등록된 사용자에 이르기까지)에서 엔드 투 엔드 고객 경험을 탐색합니다.
