...
description: AJO(Journey Optimizer)에서 규칙을 사용하여 대상자를 생성하는 원리를 이해하고 속성, 이벤트, 기존 대상자를 사용하여 대상자를 만드는 방법을 알아봅니다.
jira: KT-7553
...
>[!VIDEO](https://video.tv.adobe.com/v/3430333?quality=12&learn=on&captions=kor){transcript=true}
