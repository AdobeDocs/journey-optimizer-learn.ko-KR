...
+ 연습, 랩, 과제 {#exercises-and-challenges}
   ...
   + Summit Labs {#summit-labs}
      + [Adobe Journey Optimizer를 사용하여 개인화된 모바일 모먼트 구축(2024)](/help/summit-lab-2024/l820-lab-workbook/lab-overview.md){target="_blank"}
      + [Adobe Journey Optimizer에서 오케스트레이션을 옴니채널 참여로 확장(2025)](/help/summit-lab-2025/introduction.md){target="_blank"}
