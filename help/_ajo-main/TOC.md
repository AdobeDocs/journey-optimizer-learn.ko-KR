...
+ 캠페인 {#create-campaigns}
  ...
  + 오케스트레이션된 캠페인 {#orchestrated-campaigns}
    ...
    + [오케스트레이션된 캠페인에 대한 스키마 및 데이터 세트 설정](/help/campaigns/orchestrated-campaigns/set-up-schemas-and-datasets-for-orchestrated-campaigns.md)
...
+ 여정 {#journeys}
  ...
  + [여정 노드를 조각으로 저장](/help/journeys/journey-fragments.md)
  + 사용 사례 {#use-cases}
...
+ [충성도](https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/loyalty/introduction-to-loyalty/discover-journey-optimizer-loyalty)
...
+ 프로필, 대상자, 구독 {#profiles-audiences-subscriptions}
  ...
  + [구독 및 랜딩 페이지](/help/profiles-audiences-subscriptions/subscriptions-and-landing-pages.md)
+ 채널 {#channels}
...
+ 보고 및 모니터링 {#report-and-monitor}
  ...
  + [사용자 정의 액션 모니터링](/help/report-and-monitor/custom-action-monitoring-report.md)
  + [전체 기간 보고서를 사용하여 여정의 전체 성과 분석](/help/report-and-monitor/all-time-reports.md)
...
+ 사용 사례 및 모범 사례{#use-cases}
  ...
  + 사용 사례 플레이북 {#use-case-playbooks}
    ...
    + [플레이북 인스턴스 만들기 및 게시](https://experienceleague.adobe.com/ko/docs/platform-learn/tutorials/use-case-playbooks/create-and-publish-a-playbook-instance){target="_blank"}
+ 연습, 랩, 과제 {#exercises-and-challenges}
  ...
  + [과제](https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/challenges/introduction-and-prerequisites){target="_blank"}
