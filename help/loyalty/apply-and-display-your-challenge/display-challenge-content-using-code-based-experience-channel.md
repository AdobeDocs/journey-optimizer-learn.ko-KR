---
title: 코드 기반 경험 채널을 사용하여 과제 콘텐츠 표시
description: 코드 기반 경험을 사용하여 충성도 문제를 홍보하고, 과제 진행 상황을 표시하며, HTML 또는 JSON을 사용하여 앱 내에 개인화된 콘텐츠를 전달하는 방법을 알아봅니다.
role: User
level: Beginner
