---
user-guide-title: 양식 제출 시 여정 트리거
user-guide-description: 양식 제출 시 이메일 작업으로 여정을 트리거하는 방법에 대해 알아보기
role: Developer
level: Beginner
...
# 양식 제출 시 여정 트리거{#trigger-journey-on-form-submission}

+ [소개](./introduction.md)
+ [사용자 지정 이벤트 만들기](./custom-event.md)
