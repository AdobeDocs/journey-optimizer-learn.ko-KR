...
이 모바일 속성을 만들고 [수동으로 구성](https://experienceleague.adobe.com/ko/docs/platform-learn/data-collection/tags/create-a-property)하거나, 모바일 인앱 및 푸시에 대해 **[안내 채널 설정](https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/web-and-mobile-channels/guided-channel-setup)**&#x200B;을 사용하여 iOS 및 Android에 필요한 태그 속성, 데이터스트림 및 채널 구성을 자동으로 만들 수 있습니다.
