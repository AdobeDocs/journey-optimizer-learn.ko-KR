...
**[-> 현재 SDK 버전을 제거하려면 여기를 클릭하세요](https://developer.adobe.com/client-sdks/home/current-sdk-versions/){target="_blank"}**
