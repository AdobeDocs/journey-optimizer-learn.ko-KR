...
description: Journey Optimizer 웹 편집기에서 단일 페이지 애플리케이션(SPA)을 작성하는 방법에 대해 알아봅니다.
feature: Web Channel
role: Developer
level: Intermediate
...
Journey Optimizer 웹 편집기에서 단일 페이지 애플리케이션(SPA)을 작성하는 방법에 대해 알아봅니다.
...
>[!VIDEO](https://video.tv.adobe.com/v/3446892/?captions=kor&learn=on)
