---
user-guide-title: 마케터를 위한 Adobe Journey Optimizer의 AI 기반 온브랜드 콘텐츠 제작
user-guide-description: Adobe Journey Optimizer의 AI 기능을 사용하여 모든 채널에서 브랜드에 대한 콘텐츠를 만들고, 세분화하고, 제어하는 방법을 알아봅니다.
role: User
level: Intermediate
...
# 마케터를 위한 Adobe Journey Optimizer의 AI 기반 온브랜드 콘텐츠 제작 {#create-on-brand-content}
