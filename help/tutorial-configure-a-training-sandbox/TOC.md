---
user-guide-title: 튜토리얼 - 교육 샌드박스 구성
user-guide-description: 교육용 샌드박스 구성
breadcrumb-title: 튜토리얼 - 교육 샌드박스 구성
...
# 튜토리얼 - 교육 샌드박스 구성 {#configure-a-training-sandbox}
...
+ 1단계: 데이터 구조 설정 및 샘플 데이터 가져오기 {#set-up-data-structure-and-ingest-data}
   + [Postman을 사용하여 데이터 구조 설정 및 샘플 데이터 가져오기](https://experienceleague.adobe.com/docs/platform-learn/tutorials/import-sample-data.html?lang=ko-KR)
   + [데이터 구조 설정(수동)](/help/tutorial-configure-a-training-sandbox/manual-data-set-up.md)
   + [샘플 데이터 가져오기(수동으로)](/help/tutorial-configure-a-training-sandbox/manual-data-ingestion.md)
