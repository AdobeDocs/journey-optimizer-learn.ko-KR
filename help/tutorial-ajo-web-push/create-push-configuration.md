...
VAPID(자발적 애플리케이션 서버 식별)는 서버가 푸시 서비스(Chrome, Edge 등)에 대해 자신을 식별할 수 있도록 하는 웹 푸시 표준입니다 공개/개인 키 쌍을 사용하므로 푸시 제공자는 누가 알림을 전송하는지 알 수 있습니다.
...
* 관리로 이동 | 채널 | 푸시 설정 | 푸시 자격 증명| 푸시 자격 증명 만들기
