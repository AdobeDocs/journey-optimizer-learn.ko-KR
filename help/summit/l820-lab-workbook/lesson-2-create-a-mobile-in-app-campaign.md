...
로그인에 대한 자세한 내용은 랩 컴퓨터 바탕 화면에서 확인할 수 있습니다. Adobe ID 및 암호를 사용합니다.
   ![데스크톱](/help/summit/l820-lab-workbook/assets/desk-top.png)
...
3. 다음 두 화면을 건너뛸 수 있습니다.
   ...
   <br>
   ![Personalization 팝업](/help/summit/l820-lab-workbook/assets/2-1-4-ajo-personalization-pop-up.png)
...
값 필드 바깥쪽을 클릭하면 이미지가 표시됩니다.
   ...
   미리 보기에 ![미디어가 표시됨](/help/summit/l820-lab-workbook/assets/3-1-3-2-media.png)
...
3. 추가 옵션:
   1. **단추:**
      ...
      2. **[!UICONTROL Interact 이벤트]** 필드는 사용자가 CTA를 누를 때 SDK에 전달되는 값을 정의하는 데 사용됩니다.

      3. **[!UICONTROL Target]** 필드는 CTA가 사용자를 가져올 위치를 정의하는 데 사용됩니다. 여기에는 URL 및 딥링크가 포함됩니다. 예를 들어 `dxdemo://exoticVibes`과(와) 같은 제품 페이지에 이 딥링크를 추가할 수 있습니다.
...
3. 이제 앱의 연습 탭으로 이동합니다.
   ...
   ![연습 단추](/help/summit/l820-lab-workbook/assets/3-2-3-app-exercise-button.png)
...
1. **[!UICONTROL 캠페인 검토]** 페이지 또는 **[!UICONTROL 캠페인 작성자]** 단계에서 디바이스에서 미리 보기 기능에 액세스할 수 있습니다.
   ...
   ![장치 미리 보기 단추](/help/summit/l820-lab-workbook/assets/3-3-1-1-preview-on-device-button.png)
   <br>
...
1. Fréscopa 앱을 시작하도록 구성된 기본 URL을 입력하십시오. `dxdemo://`
   ...
   ![미리 보기 url](/help/summit/l820-lab-workbook/assets/3-3-1-3-preview-url.png)

   <br>

1. 화면의 지침을 따릅니다.
   1. 모바일 기기로 QR 코드를 스캔하면 Fréscopa 앱이 열리고 화면에 표시된 핀을 입력할 수 있습니다.
   2. 장치의 보증 화면에서 AJO에 표시된 pin을 입력하고 pin을 입력한 후 오른쪽 하단에 나타나는 연결 단추를 클릭합니다.
